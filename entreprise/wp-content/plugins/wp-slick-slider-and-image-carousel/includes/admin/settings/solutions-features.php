		...
		<div class="wpsisac-sf-inr">
			...
			<div class="wpsisac-sf-welcome-wrap">
				<div class="wpsisac-sf-welcome-inr">
					<div class="wpsisac-sf-welcome-left">
						...
						<a href="<?php echo esc_url( $popup_add_link ); ?>" class="wpsisac-sf-btn">Launch Slick Slider</a></br> <b>OR</b> </br><a href="<?php echo WPSISAC_PLUGIN_LINK_WELCOME; ?>"  target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange">Grab Now Pro Features</a>
			...
			<div class="wpsisac-features-section">
				...
				<div class="wpsisac-features-section-inr">
					...
					<a href="<?php echo WPSISAC_PLUGIN_LINK_WELCOME; ?>" target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange"><span class="dashicons dashicons-cart"></span> Grab Now Pro Features</a>
					<div class="wpsisac-rc-wrap">
						<div class="wpsisac-rc-inr wpsisac-rc-bg-box">
							<div class="wpsisac-rc-icon">
								<img src="<?php echo esc_url( WPSISAC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
			...
			<div class="wpsisac-sf-testimonial-wrap">
				...
				<div class="wpsisac-testimonial-section-inr">
					...
					<a href="https://wordpress.org/support/plugin/wp-slick-slider-and-image-carousel/reviews/?filter=5" target="_blank" class="wpsisac-sf-btn"><span class="dashicons dashicons-star-filled"></span> View All Reviews</a> OR <a href="<?php echo WPSISAC_PLUGIN_LINK_WELCOME; ?>"  target="_blank" class="wpsisac-sf-btn wpsisac-sf-btn-orange">Grab Now Pro Features</a>
					<div class="wpsisac-rc-wrap">
						<div class="wpsisac-rc-inr wpsisac-rc-bg-box">
							<div class="wpsisac-rc-icon">
								<img src="<?php echo esc_url( WPSISAC_URL ); ?>assets/images/popup-icon/14-days-money-back-guarantee.png" alt="14-days-money-back-guarantee" title="14-days-money-back-guarantee" />
