...
if( ! defined('WPSISAC_VERSION') ) {
	define( 'WPSISAC_VERSION', '3.0.9' ); // Plugin version
}
...
if( ! defined( 'WPSISAC_PLUGIN_LINK_WELCOME' ) ) {
	define('WPSISAC_PLUGIN_LINK_WELCOME','https://www.essentialplugin.com/wordpress-plugin/wp-slick-slider-and-image-carousel/?utm_source=WP&utm_medium=Slick-Slider&utm_campaign=Welcome-Screen#wpos-epb'); // Plugin Check link
}
